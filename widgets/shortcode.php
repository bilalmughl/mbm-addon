 ...
 * @since 1.0.0
 */
class bilalmghl_Shortcode_Widget extends Widget_Base {
	/**
	 * Get widget name.
	 *
    ...
    public function get_name() {
        return 'bilalmghl_Shortcode_Widget';
    }
	...
	public function get_title() {
		return __( 'Ul Form Shortcode', 'bilalmghl' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Form Shortcode', 'bilalmghl' ),
			]
		);
        ...
        $this->add_control(
			'shortcode_box',
			[
				'label'   => __( 'Shortcode', 'bilalmghl' ),
				'type'    => Controls_Manager::TEXTAREA,
				'dynamic' => [
					'active' => true,
				],
				'description' => __( 'Please enter Shortcode.','bilalmghl' ),
				'default'     => '',
				'placeholder' => '',
			]
		);
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'     => __( 'Lavel Custom CSS', 'bilalmghl' ),
    		...
    		$this->start_controls_tabs( 'tabs_input_style' );
        		$this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        'custom_input_css',
                        [
                            'label'     => __( 'Input Field CSS', 'bilalmghl' ),
                            'type'      => Controls_Manager::CODE,
                            'rows'      => 20,
                            'language'  => 'css',
                            'selectors' => [
        		...
        		$this->start_controls_tab(
        			'tab_input_focus',
        			[
        				'label' => __( 'Hover & Focus', 'bilalmghl' ),
        			]
        		);
                    ...
                    $this->add_group_control(
            			...
            			[
            				...
            				'label'    => __( 'focus Background', 'bilalmghl' ),
            				'types'    => [ 'classic', 'gradient' ],
    		...
    		$this->start_controls_tabs( 'tabs_button_style' );
        		$this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        'button_floting',
                        [
                            'label'   => __( 'Button Floating', 'bilalmghl' ),
        		...
        		$this->start_controls_tab(
                    ...
                    $this->add_group_control(
            			...
            			[
            				...
            				'label'    => __( 'Hover Background', 'bilalmghl' ),
            				'types'    => [ 'classic', 'gradient' ],
                            'separator' => 'before',
                    ...
                    $this->add_control(
                        ...
                        [
                            'label' => __( 'Hover Before Background', 'bilalmghl' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new bilalmghl_Shortcode_Widget() );