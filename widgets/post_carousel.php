...
class bilalmghl_Post_Carousel extends Widget_Base {

    public function get_name() {
        return 'bilalmghl_Post_Carousel';
    }
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'default'   => 1,
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__single__post' => 'margin: calc( {{VALUE}}px / 2 );',
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .bilalmghl__single__post',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__single__post' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__single__post' => 'overflow:hidden;border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__single__post' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__single__post' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors'          => [
                        '{{WRAPPER}} .bilalmghl__single__post' => 'margin-top: {{TOP}}{{UNIT}}; margin-bottom:{{BOTTOM}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__single__post:nth-child(2n)' => 'margin-top: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__single__post:hover' => 'transform: translateY({{SIZE}}{{UNIT}});',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'   => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__single__post .post__content' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Typography', 'bilalmghl' ),
                    'selector' => '{{WRAPPER}} .bilalmghl__single__post .post__content',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__single__post .post__content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__single__post .post__content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__single__post .post__content' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'   => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__thumb' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Typography', 'bilalmghl' ),
                            'selector' => '{{WRAPPER}} .bilalmghl__single__post .post__thumb',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Background:: get_type(),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__thumb,{{WRAPPER}} .bilalmghl__single__post .post__thumb img' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__thumb' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__thumb' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'bilalmghl' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .bilalmghl__single__post:hover .post__thumb',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Border:: get_type(),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__post:hover .post__thumb img,{{WRAPPER}} .bilalmghl__single__post:hover .post__thumb' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'   => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__single__post .post__title a' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'   => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__single__post .post__title a:hover' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Typography', 'bilalmghl' ),
                    'selector' => '{{WRAPPER}} .bilalmghl__single__post .post__title',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__single__post .post__title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__single__post .post__title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__single__post .post__title' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Typography', 'bilalmghl' ),
                            'selector' => '{{WRAPPER}} .bilalmghl__single__post .post__category li a',
                        ]
                    );
                    $this->add_control(
                        'category_color',
                        [
                            ...
                            'type'   => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__category li a' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__category li a' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__category li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__category li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'   => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__category li a:hover' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'bilalmghl' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .bilalmghl__single__post .post__category li a:hover',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__category li a:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'   => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__single__post ul.post__meta'=> 'color: {{VALUE}}',
                        '{{WRAPPER}} .bilalmghl__single__post ul.post__meta a' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Typography', 'bilalmghl' ),
                    'selector' => '{{WRAPPER}} .bilalmghl__single__post ul.post__meta li,.bilalmghl__single__post .post__author__thumb__link a',
                ]
            );
            $this->add_group_control(
                Group_Control_Background:: get_type(),
                [
                    ...
                    'label'    => __( 'Background', 'bilalmghl' ),
                    'types'    => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .bilalmghl__single__post ul.post__meta',
                ]
            );
            $this->add_group_control(
                Group_Control_Border:: get_type(),
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__single__post ul.post__meta' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__single__post ul.post__meta li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__single__post ul.post__meta li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__single__post ul.post__meta' => 'justify-content: {{VALUE}};',
                    ],
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'   => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__btn a.readmore__btn' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Typography', 'bilalmghl' ),
                            'selector' => '{{WRAPPER}} .bilalmghl__single__post .post__btn a.readmore__btn',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Background:: get_type(),
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'bilalmghl' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .bilalmghl__single__post .post__btn a.readmore__btn:after',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Border:: get_type(),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__btn a.readmore__btn' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__btn a.readmore__btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                $this->end_controls_tab();
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'   => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__btn a.readmore__btn:hover' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'bilalmghl' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .bilalmghl__single__post .post__btn a.readmore__btn:hover',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Background:: get_type(),
                        [
                            ...
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .bilalmghl__single__post .post__btn a.readmore__btn:hover:after',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Border:: get_type(),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__post .post__btn a.readmore__btn:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'bilalmghl_post_carousel', 'class', 'sldier-content-area bilalmghl__post__content__layout-'.$settings['content_layout_style']. ' '.$settings['nav_position'] );

        $this->add_render_attribute( 'bilalmghl_post_slider_item_attr', 'class', 'bilalmghl__single__post bilalmghl__post__layout__'.$settings['content_layout_style'] );


        // Slider options
        if( $settings['slider_on'] == 'yes' ){

            $this->add_render_attribute( 'bilalmghl_post_slider_attr', 'class', 'bilalmghl-carousel-activation' );
            ...
            $this->add_render_attribute( 'bilalmghl_post_slider_attr', 'data-settings', wp_json_encode( $slider_settings ) );
        }
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'bilalmghl_post_carousel' ); ?>>
                <div <?php echo $this->get_render_attribute_string( 'bilalmghl_post_slider_attr' ); ?>>
                    ...
                    ?>
                        ...
                        <?php if( $settings['content_layout_style'] == 1 ): ?>
                            ...
                            <div <?php echo $this->get_render_attribute_string( 'bilalmghl_post_slider_item_attr' ); ?> >
                        ...
                        <?php elseif( $settings['content_layout_style'] == 4 ): ?>
                            ...
                            <div <?php echo $this->get_render_attribute_string( 'bilalmghl_post_slider_item_attr' ); ?> >
                                <?php $this->bilalmghl_render_loop_content( 4 ); ?>
                            </div>
                        ...
                        <?php elseif( $settings['content_layout_style'] == 7 ): ?>
                            ...
                            <div <?php echo $this->get_render_attribute_string( 'bilalmghl_post_slider_item_attr' ); ?> >
                                <?php $this->bilalmghl_render_loop_content( 7 ); ?>
                            </div>

                        <?php elseif( $settings['content_layout_style'] == 8 ): ?>

                            <div <?php echo $this->get_render_attribute_string( 'bilalmghl_post_slider_item_attr' ); ?> >
                                <?php $this->bilalmghl_render_loop_content( 8 ); ?>
                            </div>

                        <?php elseif( $settings['content_layout_style'] == 9 ): ?>

                            <div <?php echo $this->get_render_attribute_string( 'bilalmghl_post_slider_item_attr' ); ?> >
                                <?php $this->bilalmghl_render_loop_content( 9 ); ?>
                            </div>
        ...
        $settings   = $this->get_settings_for_display(); ?>
            ...
            <?php elseif( $contetntstyle == 5 ) : ?>
                ...
                <div class="post__content">
                    <div class="post__inner">
                        <?php $this->bilalmghl_post_category(); ?>
                        <?php $this->bilalmghl_post_date(); ?>
                        <?php $this->bilalmghl_post_title(); ?>
                        <?php $this->bilalmghl_post_content(); ?>
                        <?php $this->bilalmghl_post_author(); ?>
                    </div>
                </div>
            ...
            <?php elseif( $contetntstyle == 7 ) : ?>
                ...
                <div class="post__content">
                    <div class="post__inner">
                        <?php $this->bilalmghl_post_title(); ?>
                        <?php $this->bilalmghl_post_content(); ?>
                        <?php $this->bilalmghl_post_author_comments_date_meta(); ?>
                    </div>
                </div>
    ...
    public function bilalmghl_post_date(){
        $settings   = $this->get_settings_for_display(); ?>
        <?php if( $settings['show_author'] == 'yes' || $settings['show_date'] == 'yes'): ?>
            <ul class="post__meta">
                <?php if( $settings['show_date'] == 'yes' ):?>
    ...
    public function bilalmghl_post_author(){
        $settings   = $this->get_settings_for_display(); ?>
        <?php if( $settings['show_author'] == 'yes' ): ?>
    ...
    public function bilalmghl_post_author_comments_date_meta(){
        $settings   = $this->get_settings_for_display(); ?>
        <div class="post__author__comments_date__meta">
            ...
            <div class="post__author__meta post__meta">
                ...
                <div class="comments__counts__meta">
                    <?php $this->bilalmghl_only_date(); ?>|
                    <?php $this->bilalmghl_comment_count(); ?>
                </div>
            </div>
            <?php endif; ?>
        </div>
    ...
    public function bilalmghl_only_date(){
        $settings   = $this->get_settings_for_display(); ?>
        <?php if( $settings['show_author'] == 'yes' || $settings['show_date'] == 'yes'): ?>
            <ul class="post__meta">
                <?php if( $settings['show_date'] == 'yes' ):?>
                    ...
                    <?php if( 'time_ago'== $settings['date_type'] ) : ?>
                    <li><?php echo $this->bilalmghl_time_ago(); ?></li>
                    <?php endif; ?>
                    
                    <?php if( 'date_time'== $settings['date_type'] ) : ?>
                    <li><?php echo get_the_time( 'd F y - D g:i:a' ) ?></li>
                    <?php endif; ?>
    ...
    public function bilalmghl_comment_count(){
        $settings   = $this->get_settings_for_display();
...
Plugin::instance()->widgets_manager->register_widget_type( new bilalmghl_Post_Carousel() );