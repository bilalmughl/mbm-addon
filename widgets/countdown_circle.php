 ...
 * @since 1.0.0
 */
class bilalmghl_Countdown_Circle_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'bilalmghl_Countdown_Circle_Widget';
	}
	...
	public function get_title() {
		return __( 'Ul Circle Countdown', 'bilalmghl' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'countdown_date',
			[
				'label' => __( 'Target Date', 'bilalmghl' ),
		...
		$this->add_control(
			'countdown_animation',
			[
				'label'     => __( 'Animation', 'bilalmghl' ),
				'type'      => Controls_Manager::SELECT,
				'options' => [
					'smooth' => __('Smooth','bilalmghl'),
					'ticks'  => __('Ticks','bilalmghl'),
				],
				'default' => 'smooth',
			]
		);
		...
		$this->add_control(
			'start_angle',
			[
				'label'      => __( 'Start Angle', 'bilalmghl' ),
		...
		$this->add_control(
			'circle_bg_color',
			[
				'label'   => __( 'Circle Bg Color', 'bilalmghl' ),
		...
		$this->add_control(
			'counter_width',
			[
				'label'      => __( 'Circle Width', 'bilalmghl' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'bg_width',
			[
				'label'      => __( 'Background Width', 'bilalmghl' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'days_circle_color',
			[
				'label'   => __( 'Days Circle Color', 'bilalmghl' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#ef296c',
			]
		);
		...
		$this->add_control(
			'hours_circle_color',
			[
				'label'   => __( 'Hours Circle Color', 'bilalmghl' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#18bfc3',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => __( 'Minutes Circle Color', 'bilalmghl' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#ffd200',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => __( 'Seconds Circle Color', 'bilalmghl' ),
				'type'    => Controls_Manager::COLOR,
				'default' => '#182eff',
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'countdown_circle_wrap', [
			'class' => 'bilalmghl__circle__countdown',
		] );
		...
		<div <?php echo $this->get_render_attribute_string( 'countdown_circle_wrap' ); ?>>
			<div id="bilalmghl__circle__countdown__<?php echo esc_attr( $random_id ); ?>"  data-date="<?php echo esc_attr( $data_time ); ?>"></div>
		</div>
	<?php 
	} 
}
Plugin::instance()->widgets_manager->register_widget_type( new bilalmghl_Countdown_Circle_Widget() );