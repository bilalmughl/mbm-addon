...
class bilalmghl_Icon_List_Widget extends Widget_Base {

    public function get_name() {
        return 'bilalmghl_Icon_List_Widget';
    }
    
    public function get_title() {
        return __( 'Ul Icon Listing', 'bilalmghl' );
    }
    ...
    public function bilalmghl_infobox_style(){
        return [
            'icon__list__style__1' => __( 'Style One', 'bilalmghl' ),
            'icon__list__style__2' => __( 'Style Two', 'bilalmghl' ),
            'icon__list__style__3' => __( 'Style Three', 'bilalmghl' ),
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Icon list Content Style', 'bilalmghl' ),
            ]
        );
            $this->add_control(
                'icon_listing_style',
                [
                    'label'   => __( 'Icon List Style', 'bilalmghl' ),
            ...
            $this->add_control(
                'description', [
                    'label'       => __( 'Header Description', 'bilalmghl' ),
            ...
            $repeater->start_controls_tab(
                ...
                $repeater->add_control(
                    'list_content', [
                        'label'      => __( 'List Content', 'bilalmghl' ),
            ...
            $repeater->start_controls_tab(
                ...
                $repeater->add_control(
                    ...
                    [
                        'label' => __( 'Current Item Icon Style', 'bilalmghl' ),
                ...
                $repeater->add_control(
                    'current_item_color',
                    [
                        'label'     => __( 'Description Color', 'bilalmghl' ),
                        'type'      => Controls_Manager::COLOR,
                        'separator' => 'before',
                        'selectors' => [
            ...
            $repeater->start_controls_tab(
                ...
                $repeater->add_control(
                    ...
                    [
                        'label' => __( 'Current Item Hover Icon Style', 'bilalmghl' ),
                        'type'  => Controls_Manager::HEADING,
                    ]
                );
                $repeater->add_control(
            ...
            $this->add_control(
                'list_content',
                [
                    'label'   => __( 'Add Info Boxes', 'bilalmghl' ),
                    ...
                    'default' => [
                        [
                            ...
                            'list_title' => __( 'List Item #1', 'bilalmghl' ),
                        ],
                        [
                            'list_icon'   => [
                                'value' => 'fas fa-check',
                            ...
                            'list_title' => __( 'List Item #2', 'bilalmghl' ),
                        ],
                        [
                            'list_icon'   => [
                                'value' => 'fas fa-check',
                            ...
                            'list_title' => __( 'List Item #3', 'bilalmghl' ),
                        ],
                    ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Infobox Wrapper', 'bilalmghl' ),
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Background', 'bilalmghl' ),
                    'types'    => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .bilalmghl__icon__listing__wrap',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__icon__listing__wrap' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
            $this->add_group_control(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__icon__listing__wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_group_control(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__icon__listing__wrap' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__icon__listing__wrap' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        $this->end_controls_section();
            ...
            $this->start_controls_tabs( 'icon_tabs_style' );
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        'icon_width',
                        [
                            'label'      => __( 'Icon Wrap Width', 'bilalmghl' ),
                    ...
                    $this->add_responsive_control(
                        'icon_height',
                        [
                            'label'      => __( 'Icon Wrap Height', 'bilalmghl' ),
                            'type'       => Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%' ],
                            'range'      => [
                                'px' => [
        ...
        $this->start_controls_section(
            'box_style_section',
            [
                'label' => __( 'Single Info Box', 'bilalmghl' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'bilalmghl_icon_listing_attr', 'class', 'bilalmghl__icon__listing__wrap' );
        $this->add_render_attribute( 'bilalmghl_icon_listing_attr', 'class', $settings['icon_listing_style'] );

        ?>
            <div <?php echo $this->get_render_attribute_string('bilalmghl_icon_listing_attr'); ?> >

                <?php if( !empty( $settings['title'] ) ): ?>
                    <div class = "icon__list__header__title">
                        <h3><?php echo esc_html( $settings['arrows_styles'] ); ?></h3>
                    </div>
                <?php endif; ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new bilalmghl_Icon_List_Widget() );