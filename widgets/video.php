 ...
 * @since 1.0.0
 */
class bilalmghl_Widget_Video extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'video_type',
			[
				'label'   => __( 'Source', 'bilalmghl' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'youtube',
				'options' => [
					'youtube'     => __( 'YouTube', 'bilalmghl' ),
					'vimeo'       => __( 'Vimeo', 'bilalmghl' ),
					'dailymotion' => __( 'Dailymotion', 'bilalmghl' ),
					'hosted'      => __( 'Self Hosted', 'bilalmghl' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your URL', 'bilalmghl' ) . ' (YouTube)',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your URL', 'bilalmghl' ) . ' (Vimeo)',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your URL', 'bilalmghl' ) . ' (Dailymotion)',
		...
		$this->add_control(
			'insert_url',
			[
				'label'     => __( 'External URL', 'bilalmghl' ),
		...
		$this->add_control(
			'hosted_url',
			[
				'label'   => __( 'Choose File', 'bilalmghl' ),
		...
		$this->add_control(
			...
			[
				...
				'media_type'  => 'video',
				'placeholder' => __( 'Enter your URL', 'bilalmghl' ),
				'condition'   => [
					'video_type' => 'hosted',
					'insert_url' => 'yes',
				],
		...
		$this->add_control(
			'start',
			[
				'label'       => __( 'Start Time', 'bilalmghl' ),
				'type'        => Controls_Manager::NUMBER,
				'description' => __( 'Specify a start time (in seconds)', 'bilalmghl' ),
				'condition'   => [
					'loop' => '',
				],
			]
		...
		$this->add_control(
			'end',
			[
				'label'       => __( 'End Time', 'bilalmghl' ),
				'type'        => Controls_Manager::NUMBER,
				'description' => __( 'Specify an end time (in seconds)', 'bilalmghl' ),
				'condition'   => [
					'loop'       => '',
		...
		$this->add_control(
			'video_options',
			[
				'label'     => __( 'Video Options', 'bilalmghl' ),
		...
		$this->add_control(
			'controls',
			[
				'label'     => __( 'Player Controls', 'bilalmghl' ),
				'type'      => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'modestbranding',
			[
				'label'     => __( 'Modest Branding', 'bilalmghl' ),
				'type'      => Controls_Manager::SWITCHER,
				'condition' => [
					'video_type' => [ 'youtube' ],
					'controls'   => 'yes',
		...
		$this->add_control(
			'color',
			[
				'label'     => __( 'Controls Color', 'bilalmghl' ),
		...
		$this->add_control(
			'yt_privacy',
			[
				'label'       => __( 'Privacy Mode', 'bilalmghl' ),
				'type'        => Controls_Manager::SWITCHER,
				'description' => __( 'When you turn on privacy mode, YouTube won\'t store information about visitors on your website unless they play the video.', 'bilalmghl' ),
				'condition'   => [
					'video_type' => 'youtube',
				],
			]
		...
		$this->add_control(
			'rel',
			[
				'label'   => __( 'Suggested Videos', 'bilalmghl' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					''    => __( 'Current Video Channel', 'bilalmghl' ),
					'yes' => __( 'Any Video', 'bilalmghl' ),
				],
				'condition' => [
					'video_type' => 'youtube',
				],
		...
		$this->add_control(
			'vimeo_title',
			[
				'label'     => __( 'Intro Title', 'bilalmghl' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'bilalmghl' ),
				'label_on'  => __( 'Show', 'bilalmghl' ),
				'default'   => 'yes',
		...
		$this->add_control(
			'vimeo_portrait',
			[
				'label'     => __( 'Intro Portrait', 'bilalmghl' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'bilalmghl' ),
				'label_on'  => __( 'Show', 'bilalmghl' ),
				'default'   => 'yes',
		...
		$this->add_control(
			'vimeo_byline',
			[
				'label'     => __( 'Intro Byline', 'bilalmghl' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'bilalmghl' ),
				'label_on'  => __( 'Show', 'bilalmghl' ),
				'default'   => 'yes',
		...
		$this->add_control(
			'download_button',
			[
				'label'     => __( 'Download Button', 'bilalmghl' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'bilalmghl' ),
				'label_on'  => __( 'Show', 'bilalmghl' ),
				'condition' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Image Overlay', 'bilalmghl' ),
			]
		);
		...
		$this->add_control(
			'image_overlay',
			[
				'label'   => __( 'Choose Image', 'bilalmghl' ),
				'type'    => Controls_Manager::MEDIA,
				'default' => [
		...
		$this->add_control(
			'play_icon',
			[
				'label'     => __( 'Chose Play Icons', 'bilalmghl' ),
		...
		$this->add_control(
			'aspect_ratio',
			[
				'label'   => __( 'Aspect Ratio', 'bilalmghl' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'169' => '16:9',
					'219' => '21:9',
		...
		$this->add_control(
			...
			[
				'label'     => __( 'UI Hover Color', 'bilalmghl' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'   => __( 'Content Width', 'bilalmghl' ),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'unit' => '%',
				],
		...
		$this->add_control(
			...
			[
				'label'              => __( 'Content Position', 'bilalmghl' ),
				'type'               => Controls_Manager::SELECT,
				'frontend_available' => true,
				'options'            => [
					''    => __( 'Center', 'bilalmghl' ),
					'top' => __( 'Top', 'bilalmghl' ),
				],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'              => __( 'Entrance Animation', 'bilalmghl' ),
		...
		<div <?php echo $this->get_render_attribute_string( 'video-wrapper' ); ?>>
			...
			if ( $this->has_image_overlay() ) {
				...
				<div <?php echo $this->get_render_attribute_string( 'image-overlay' ); ?>>
					<?php if ( $settings['lightbox'] && 'yes' == $settings['show_image_overlay'] ) : ?>
					...
					<?php if ( 'yes' === $settings['show_play_icon'] ) : ?>
						<div class="video__play__button" role="button">
							<?php echo bilalmghl_render_icons( $settings['play_icon'] ); ?>
						</div>
					<?php endif; ?>
				</div>
			<?php } ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new bilalmghl_Widget_Video() );