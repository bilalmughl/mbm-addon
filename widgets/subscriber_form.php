...
class bilalmghl_Subscriber_Widget extends Widget_Base {

	public function get_name() {
		return 'bilalmghl_Subscriber_Widget';
	}

	public function get_title() {
		return __( 'Ul Subscribe Form', 'bilalmghl' );
	}
	...
	protected function render() {
		...
		if ( !empty(  $settings['button_icon'] ) ) {
			if (  'left' == $settings['button_icon_align'] ) {
				$button = '<button '.$this->get_render_attribute_string( 'submit_button' ).'>' . bilalmghl_render_icons( $settings['button_icon'], 'subscribe__btn_icon_left' ) . esc_html( $settings['button_text'] ) .'</button>';
			}elseif( 'right' == $settings['button_icon_align'] ){
				$button = '<button '.$this->get_render_attribute_string( 'submit_button' ).'>'. esc_html( $settings['button_text'] ) . bilalmghl_render_icons( $settings['button_icon'], 'subscribe__btn_icon_right' ) . '</button>';
			}
		}
...
Plugin::instance()->widgets_manager->register_widget_type( new bilalmghl_Subscriber_Widget() );