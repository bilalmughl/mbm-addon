...
class bilalmghl_Portfolio_Carousel extends Widget_Base {

    public function get_name() {
        return 'bilalmghl_Portfolio_Carousel';
    }
    
    public function get_title() {
        return __( 'Ul Portfolio Carousel', 'bilalmghl' );
    }
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Typography', 'bilalmghl' ),
                            'selector' => '{{WRAPPER}} .bilalmghl__single__portfolio .portfolio__category li a',
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'   => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__portfolio .portfolio__category li a' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__portfolio .portfolio__category li a' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .bilalmghl__single__portfolio .portfolio__category li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .bilalmghl__single__portfolio .portfolio__category li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'   => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__portfolio .portfolio__category li a:hover' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'bilalmghl' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .bilalmghl__single__portfolio .portfolio__category li a:hover',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__single__portfolio .portfolio__category li a:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'bilalmghl_post_carousel', 'class', 'sldier-content-area bilalmghl__portfolio__content__layout-'.$settings['content_layout_style']. ' '.$settings['nav_position'] );

        $this->add_render_attribute( 'bilalmghl_post_slider_item_attr', 'class', 'bilalmghl__single__portfolio bilalmghl__portfolio__layout__'.$settings['content_layout_style'] );
...
Plugin::instance()->widgets_manager->register_widget_type( new bilalmghl_Portfolio_Carousel() );