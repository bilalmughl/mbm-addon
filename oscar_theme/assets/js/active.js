;(function ($) {
    ...
    var Oscar_Adv_Accordion_Script_Handle = function($scope, $) {
        var $advanceAccordion     = $scope.find(".oscar__adv__accordion"),
            $accordionHeader      = $scope.find(".oscar__accordion__header"),
        ...
        $accordionHeader.click(function(e) {
            ...
            if ($accordionType === "accordion") {
                if ($this.hasClass("show")) {
                    ...
                    $this.parent().parent().find(".oscar__accordion__header").removeClass("show active");
                    $this.parent().parent().find(".oscar__accordion__content").slideUp($accordionSpeed);
        ...
        TABS ACTIVE
    ----------------------------------*/
    var Oscar_Tabs_Script = function($scope ,$){
    ...
    var Owl_Carousel_Script_Handle = function ($scope, $){
        ...
        var carousel_elem     = $scope.find('.oscar-carousel-active').eq(0);
        ...
        if ( carousel_elem.length > 0 ) {
            ...
            if( carousel_style_ck == 4 ){
                carousel_elem.slick({
                    ...
                    arrows      : arrows,
                    prevArrow   : '<div class="oscar-carosul-prev owl-prev"><i class="'+arrow_prev_txt+'"></i></div>',
                    nextArrow   : '<div class="oscar-carosul-next owl-next"><i class="'+arrow_next_txt+'"></i></div>',
                    dots        : dots,
    ...
    var Swiper_Carousel_Script_Handle = function ($scope, $) {
        ...
        var mobile_item_scroll = parseInt(settings['mobile_item_scroll']) || 1;
            ...
            if ( arrows === true ) {                
               var  navigation = {
                    nextEl: '.oscar-carosul-next'+slideid,
                    prevEl: '.oscar-carosul-prev'+slideid,
                };
            }else{
                var navigation = '';
            }
            ...
            if ( dots === true ) {
                var dots_type 
                var pagination = {
                    el                : '.oscar-carousel-dots'+slideid,
    ...
    /*--------------------------------
        CIRCLE PROGRESSBAR
    ---------------------------------*/
    var Oscar_Counter_Circle_Widget_Script_Handle = function($scope, $) {
        
        var circle_progressbar  = $scope.find('.oscar__progress__counter').eq(0);
        ...
        var active_progressbar = $("#oscar__progress__counter__"+random_id+"");
    ...
    ----------------------------------*/
    var Oscar_Countdown_Circle_Timer_Script = function ($scope, $) {
        var countdown_time_circle = $scope.find('.oscar__circle__countdown').eq(0);
        ...
        var countdown             = $("#oscar__circle__countdown__"+random_id+"");
    ...
    ---------------------------------*/
    var Oscar_Give_Campains_Widget_Script = function () {
    ...
    var Timeline_Script_Handle_Data = function ( $scope, $ ){
        ...
        var timeline_content         = $scope.find('.oscar__timeline__activation').eq(0);
        ...
        $('#oscar__timeline__'+timeline_id+' .timeline').timeline({
    ...
    var Timeline_Roadmap_Script_Handle_Data = function ( $scope, $ ){
        var roadmap_content = $scope.find('.oscar__roadmap__activation').eq(0);
        ...
        $( '#oscar__roadmap__timeline__'+random_id ).roadmap(content, {
    ...
    -------------------------------------*/
    var Oscar_Progressbar_Script = function () {
        $('.oscar__progressbar').each(function () {
            $(this).appear(function () {
                $(this).find('.count__bar').animate({
                    width: $(this).attr('data-percent')
                }, 1000);
    ...
    -------------------------------------*/
    var Oscar_Masonry_Filter_Script = function($scope, $ ){
        var grid_elem            = $scope.find('.oscar-filter-activation').eq(0);
        ...
        if ( 'slider' != settings['gallery_type'] || 'genaral' != settings['gallery_type'] ) {
            ...
            var item_selector        = '.oscar__grid__item__'+gallery_id;
    ...
    /*var WidgetImageMasonaryHandler = function ($scope, $) {
        var masonry_elem = $scope.find('.oscar-masonry-activation').eq(0);
    ...
    -----------------------------------------*/
    var Oscar_Product_Tabs_Filter = function(){
    ...
    -----------------------------------------*/
    var Oscar_Edd_Search_Widget_Script = function($scope, $){
    ...
    /*---------------------------------------
        EDD CATEGORY SEARCH FEATURES SELECT
    -----------------------------------------*/
    var Oscar_Tooltip_Modal_Script = function($scope, $){

        var tooltip_content = $('.oscar__toltip__modal');
    ...
    -----------------------------------------*/
    var Oscar_Add_Span_To_First_Word = function($scope, $){
    ...
    var Animate_Headline_Script = function($scope,$){
        ...
        var headline_content = $scope.find('.oscar__animate__heading__activation').eq(0);
    ...
    var Oscar_Flip_Box_Script = function( $scope, $){
    ...
    var Oscar_Progress_Script = function($scope, $){
        var element             = $scope.find( '.oscar__progressbar__activation' ).eq(0);
    ...
    var Oscar_Image_Compare_Script = function($scope, $){
    ...
    var Global_Element_Ready_Script = function( $scope ){
        ...
        var OscarFloatingEffect = elementorModules.frontend.handlers.Base.extend({
            onInit: function () {
            ...
            getConfig: function (key) {
                return this.getElementSettings('oscar_floating_fx_' + key);
            },
        ...
        new oscarFloatingEffect({
            $element: $scope
        });
    }

    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Adv_Accordion.default', Oscar_Adv_Accordion_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Animate_Headline.default', Animate_Headline_Script );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/OscarTestmonial.default', Owl_Carousel_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/OscarTeams.default', Owl_Carousel_Script_Handle );


        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Multi_Gallery_Widget.default', Slick_Carousel_Script_Handle );        
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Multi_Gallery_Widget.default', Oscar_Masonry_Filter_Script );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Instagram_Widget.default', Slick_Carousel_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Post_Carousel.default', Slick_Carousel_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Post_Carousel.default', Oscar_Add_Span_To_First_Word );
        /*elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Post_Group.default', Oscar_Post_Group_Script );*/

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_WooCommerce_Products_Widget.default', Oscar_Product_Tabs_Filter );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Portfolio_Carousel.default', Slick_Carousel_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Portfolio.default', Slick_Carousel_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Portfolio.default', Oscar_Masonry_Filter_Script );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Image_Carousel.default', Slick_Carousel_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Subscriber_Widget.default', MailChimp_Subscribe_Form_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Image_Carousel_Alt.default', Swiper_Carousel_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Video_Button.default', Video_Popup_Button_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Counter_Circle_Widget.default', Oscar_Counter_Circle_Widget_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Countdown_Circle_Widget.default', Oscar_Countdown_Circle_Timer_Script );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Give_Campains_Widget.default', Oscar_Give_Campains_Widget_Script );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Give_Campains_Widget.default', Slick_Carousel_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Timeline_Widget.default', Timeline_Script_Handle_Data);

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Timeline_Roadmap_Widget.default', Timeline_Roadmap_Script_Handle_Data);

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Step_Timeline_Widget.default', Slick_Carousel_Script_Handle );
        
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Progress_Roadmap_Widget.default', Oscar_Progressbar_Script );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Progressbar_Widget.default', Oscar_Progress_Script );
...
//**oscarrrrr**
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Timeline_Slides_Widget.default', Slider_Video_Popup_Button_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Timeline_Slides_Widget.default', Oscar_Slider_Animation_Script );


        /* EDD FEATURES ENABLE*/
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Edd_Search_Widget.default', Oscar_Edd_Search_Widget_Script );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Edd_Products_Widget.default', Slick_Carousel_Script_Handle );        
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Edd_Products_Widget.default', Oscar_Masonry_Filter_Script );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Edd_Products_Widget.default', Oscar_Tooltip_Modal_Script );        
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Thumb_Category_Widget.default', Slick_Carousel_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Scroll_Button.default', Scroll_Buttom_Script );
        
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Tabs_Menu_Widget.default', Oscar_Tabs_Script );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/Oscar_Price_Tabs_Widget.default', Oscar_Tabs_Script );
