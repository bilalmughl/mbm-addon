...
class bilalmghl_Welcome_Slides_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Ul Welcome Slides', 'bilalmghl' );
    }
    ...
    static function content_layout_style(){
        return[
            'welcome__slides__layout__1'      => esc_html__( 'Style One', 'bilalmghl' ),
                ...
                $repeater->start_controls_tab(
                    ...
                    $repeater->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} {{CURRENT_ITEM}} .welcome__slide__item__content .welcome_slide_button_2 .bilalmghl__btn_icon' => 'color: {{VALUE}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $repeater->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} {{CURRENT_ITEM}} .welcome__slide__item__content .welcome_slide_button_2:hover .bilalmghl__btn_icon' => 'color: {{VALUE}} !important;',
                            ],
                            'separator' => 'before',
                        ]
                    );
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'default'   => 1,
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__welcome__slide__item' => 'margin: calc( {{VALUE}}px / 2 );',
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__welcome__slide__item' => 'height: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__welcome__slide__item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__welcome__slide__item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        $this->end_controls_section();   
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'bilalmghl_content_main_wrap', 'class', 'bilalmghl-welcome-slides-content-area' );
        ...
        if( $settings['slider_on'] == 'yes' ){
            ...
            $this->add_render_attribute( 'bilalmghl_content_wrap_attr', 'class', 'bilalmghl-welcome-area' );
        }

        // Slider Item Main Class
        $this->add_render_attribute( 'bilalmghl_carousel_item_parent_attr', 'class', 'bilalmghl__welcome__slide__item' );
        $this->add_render_attribute( 'bilalmghl_carousel_item_parent_attr', 'class', $settings['content_layout_style'] );

        // Item Content Class
        $this->add_render_attribute( 'bilalmghl_carousel_item_attr', 'class', 'welcome__slide__item__content' );
                 ...
                 <!-- foreach ( $settings['content_slide_list'] as $_single ): ?> -->
                    ...
                    <?php
                        $slide_item_attribute = [
                            'bilalmghl__welcome__slide__item',
...
<?php else : ?>
                    ...
                    <?php else : ?>
                        ...
                        <div class="single__welcome__slide__bg__overlay jhjsdjhdjh"></div>
                        <div <?php echo $this->get_render_attribute_string('bilalmghl_carousel_item_attr'); ?>>
