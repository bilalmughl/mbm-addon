...
class bilalmghl_Info_Box_Widget extends Widget_Base {

    public function get_name() {
        return 'bilalmghl_Info_Box_Widget';
    }
    
    public function get_title() {
        return __( 'Ul Info Box', 'bilalmghl' );
    }
    ...
    public function bilalmghl_infobox_style(){
        return [
            'bilalmghl__infobox__style__1' => __( 'Style One', 'bilalmghl' ),
            'bilalmghl__infobox__style__2' => __( 'Style Two', 'bilalmghl' ),
            'bilalmghl__infobox__style__3' => __( 'Style Three', 'bilalmghl' ),
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Infobox Content & Style', 'bilalmghl' ),
            ]
        );
            $this->add_control(
                'info_box_style',
                [
                    'label'   => __( 'Infobox Style', 'bilalmghl' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => 'bilalmghl__infobox__style__1',
            ...
            $repeater->start_controls_tab(
                ...
                $repeater->add_control(
                    'list_content', [
                        'label'      => __( 'Info Content', 'bilalmghl' ),
                ...
                [
                    ...
                    'default' => [
                        [
                            ...
                            'list_title'   => __( 'PHONE:', 'bilalmghl' ),
                            'list_content' => __( '+88 01744 430 440', 'bilalmghl' ),
                        ],
                        [
                            'list_icon'   => [
                                'value' => 'far fa-envelope',
                            ],
                            'list_title'   => __( 'EMAIL:', 'bilalmghl' ),
                            'list_content' => __( 'mehedidb@gmail.com', 'bilalmghl' ),
                        ],
                        [
                            'list_icon'   => [
                                'value' => 'fas fa-map-marker-alt',
                            ],
                            'list_title'   => __( 'LOCATION:', 'bilalmghl' ),
                            'list_content' => __( '44 Canal Center Plaza #200 Alexandria, VA 22314, USA', 'bilalmghl' ),
                        ],
                    ],
...
Plugin::instance()->widgets_manager->register_widget_type( new bilalmghl_Info_Box_Widget() );