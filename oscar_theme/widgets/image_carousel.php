...
class bilalmghl_Image_Carousel extends Widget_Base {

    public function get_name() {
        return 'bilalmghl_Image_Carousel';
    }
    
    public function get_title() {
        return __( 'Ul Image Carousel', 'bilalmghl' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label'   => esc_html__( 'Carousel Style', 'bilalmghl' ),
            ...
            $this->add_control(
                'link_click_event',
                [
                    'label'   => __( 'Click Event', 'bilalmghl' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => 'none',
                    'options' => [
                        'none'        => __( 'None', 'bilalmghl' ),
                        'lightbox'    => __( 'Lightbox', 'bilalmghl' ),
                        'custom_link' => __( 'Custom Link', 'bilalmghl' ),
                    ],
                    'separator' => 'before',
                ]
            );
            ...
            $repeater->add_control(
                'carosul_image_title',
                [
                    'label'   => __( 'Image Caption', 'bilalmghl' ),
            ...
            $repeater->add_control(
                'custom_link',
                [
                    'label'         => __( 'Custom Link', 'bilalmghl' ),
                    'type'          => Controls_Manager::URL,
                    'placeholder'   => __( 'http://your-link.com', 'bilalmghl' ),
                    'show_external' => true,
                    'default'       => [
                        'url'         => '#',
                        'is_external' => false,
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => [
                        [
                            'carosul_image_title' => __('Image Title #1','bilalmghl'),
                        ],
            ...
            $this->add_control(
                'show_caption',
                [
                    'label'        => __( 'Display Caption', 'bilalmghl' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => __( 'On', 'bilalmghl' ),
                    'label_off'    => __( 'Off', 'bilalmghl' ),
                    'return_value' => 'yes',
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __( 'Column Style', 'bilalmghl' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'slider_on!' => 'yes',
                ]
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__image__slide__item__parent' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );        
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__image__slide__item__parent' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );        
    		$this->add_responsive_control(
    			...
    			[
    				...
    				'selectors' => [
    					'{{WRAPPER}} .bilalmghl__image__slide__item__parent' => 'width: {{SIZE}}{{UNIT}};',
    				],
    			]
    		);
        $this->end_controls_section();
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __( 'Center Item Style', 'bilalmghl' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'slider_on'    => 'yes',
                    'slcentermode' => 'yes',
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector'  => '{{WRAPPER}} .bilalmghl__image__slide__item__parent.slick-active.slick-center img',
                ]
            );
            $this->add_control(
                'center_item_opacity',
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__image__slide__item__parent.slick-active.slick-center' => 'opacity:{{SIZE}};',
                        '{{WRAPPER}} .slick-active.slick-center .bilalmghl__image__slide__item__parent' => 'opacity:{{SIZE}};',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__image__slide__item__parent.slick-active.slick-center' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        '{{WRAPPER}} .slick-active.slick-center .bilalmghl__image__slide__item__parent' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );        
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__image__slide__item__parent.slick-active.slick-center' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                        '{{WRAPPER}} .slick-active.slick-center .bilalmghl__image__slide__item__parent' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__image__slide__item__parent.slick-active.slick-center' => 'transform: scale({{SIZE}});',
                        '{{WRAPPER}} .slick-active.slick-center .bilalmghl__image__slide__item__parent' => 'transform: scale({{SIZE}});',
                    ],
                    'separator' => 'before',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__image__slide__item__parent' => 'transition: {{SIZE}}s;',
        ...
        --------------------------*/
        $this->start_controls_section(
            'bilalmghl_carousel_style_section',
            [
                'label' => __( 'Item Style', 'bilalmghl' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
            $this->add_group_control(
            ...
            $this->add_responsive_control(
                'item_image_width',
                [
                    'label'      => __( 'Item Image Width', 'bilalmghl' ),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%', 'vw' ],
                    'range'      => [
                        'px' => [
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__image__slide__item__parent' => 'opacity:{{SIZE}};',
                    ],
                ]
            );
            $this->add_group_control(
           ...
           $this->add_group_control(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        'align-items:center;'  => __( 'Center', 'bilalmghl' ),
                        'align-items:flex-start;'  => __( 'Start', 'bilalmghl' ),
                        'align-items:flex-end;'  => __( 'End', 'bilalmghl' ),
                    ],
                    'selectors' => [
            ...
            $this->add_responsive_control(
                'nth_child_margin',
                [
                    'label'      => __( 'Item Nth Child 2 Margin Vartically', 'bilalmghl' ),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
                    'range'      => [
                        'px' => [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__image__slide__item__parent:nth-child(2n)' => 'margin-top: {{SIZE}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_responsive_control(
                'item_hover_margin',
                [
                    'label'      => __( 'Item Hover Offset Vartically', 'bilalmghl' ),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
                    'range'      => [
                        'px' => [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__image__slide__item__parent:hover' => 'transform: translateY({{SIZE}}{{UNIT}});',
                    ],
                    'separator' => 'before',
                ]
            );
        ...
        $this->start_controls_section(
            'box_title_section',
            [
                'label'     => __( 'Caption Style', 'bilalmghl' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_caption' => 'yes'
                ]
		...
		$this->add_control(
			...
			[
				'label'   => __( 'Transition Duration', 'bilalmghl' ),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0.3,
				],
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .sldier-content-area .slick-arrow i' => 'font-size: {{SIZE}}{{UNIT}};',
                                '{{WRAPPER}} .sldier-content-area .slick-arrow svg' => 'width: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__( 'Slider Pagination Warp', 'bilalmghl' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'slider_on' => 'yes',
                    'sldots'    => 'yes',
    ...
    protected function render( $instance = [] ) {
        ...
        // Carousel Attribute
        $this->add_render_attribute( 'bilalmghl_carousel_wrap', 'class', 'sldier-content-area '.$settings['nav_position'] );
        // Slider Attr
        /*$this->add_render_attribute( 'bilalmghl_carousel_attr', 'class', 'bilalmghl__content__or__slider' );*/

        if( $settings['slider_on'] == 'yes' ){

            $this->add_render_attribute( 'bilalmghl_carousel_attr', 'class', 'bilalmghl-carousel-activation' );
            ...
            $this->add_render_attribute( 'bilalmghl_carousel_attr', 'data-settings', wp_json_encode( $slider_settings ) );
        }else{
            $this->add_render_attribute( 'bilalmghl_carousel_attr', 'class', 'bilalmghl__slide__content__grid' );            
        }

        $this->add_render_attribute( 'bilalmghl_carousel_item_parent_attr', 'class', 'bilalmghl__image__slide__item__parent' );
        $this->add_render_attribute( 'bilalmghl_carousel_item_attr', 'class', 'single__image__slide bilalmghl__image__slide__layout__'.$settings['content_layout_style'] );
        ?>
        <div <?php echo $this->get_render_attribute_string('bilalmghl_carousel_wrap'); ?>>
            <div <?php echo $this->get_render_attribute_string('bilalmghl_carousel_attr'); ?>>

                <?php foreach ( $settings['carosul_image_list'] as $imagecarosul ): ?>
                    <div <?php echo $this->get_render_attribute_string('bilalmghl_carousel_item_parent_attr'); ?>>
...
Plugin::instance()->widgets_manager->register_widget_type( new bilalmghl_Image_Carousel() );