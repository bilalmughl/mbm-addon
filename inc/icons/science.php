...
function bilalmghl_science_sets(){
	$icons = array(
		'science-001-skull',
		'science-002-plant',
		'science-003-moon',
...
class bilalmghl_Add_Science_Icons {
    
    public function __construct() { 
		add_action( 'elementor/editor/after_enqueue_styles', [ $this, 'bilalmghl_enqueue_science' ] );
		add_action( 'elementor/frontend/after_enqueue_styles', [ $this, 'bilalmghl_enqueue_science' ] );    
		add_filter( 'elementor/icons_manager/additional_tabs', [ $this, 'bilalmghl_elementor_science_setup' ] );
	}
    
    public function bilalmghl_enqueue_science(){
        wp_enqueue_style( 'science', BILALMGHL_ADDONS_ROOT_ICON . 'science/science.css', array(), '1.0.1' );
    }

	public function bilalmghl_elementor_science_setup( $tabs = array()){

		$new_icons = bilalmghl_science_sets();

		$tabs['science'] = array(
			'name'          => 'science',
			'label'         => esc_html__( 'Science Icons', 'bilalmghl' ),
			'labelIcon'     => 'science-014-planets',
			'prefix'        => '',
			'displayPrefix' => 'science',
			'url'           => BILALMGHL_ADDONS_ROOT_ICON . 'science/science.css',
			'icons'         => $new_icons,
			'ver'           => '1.0.0',
		);
		return $tabs;
...
new bilalmghl_Add_Science_Icons();