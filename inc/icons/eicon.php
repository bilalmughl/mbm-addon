...
class bilalmghl_Add_Eicon_Icons {
    
    public function __construct() { 
		add_action( 'elementor/editor/after_enqueue_styles', [ $this, 'bilalmghl_enqueue_eicon' ] );
		add_action( 'elementor/frontend/after_enqueue_styles', [ $this, 'bilalmghl_enqueue_eicon' ] );    
		add_filter( 'elementor/icons_manager/additional_tabs', [ $this, 'bilalmghl_elementor_eicon_setup' ] );
	}
    
    public function bilalmghl_enqueue_eicon(){
        wp_enqueue_style( 'eicons', BILALMGHL_ADDONS_ROOT_ICON . 'eicons/eicons.css', array(), '1.0.0' );
    }

	public function bilalmghl_elementor_eicon_setup( $tabs = array()){

		$new_icons = bilalmghl_eicon_sets();

		$tabs['eicon'] = array(
			'name'          => 'eicon',
			'label'         => esc_html__( 'Elementor Icons', 'bilalmghl' ),
			'labelIcon'     => 'eicon-elementor',
			'prefix'        => '',
			'displayPrefix' => 'eicon',
			'url'           => BILALMGHL_ADDONS_ROOT_ICON . 'eicons/eicons.css',
			'icons'         => $new_icons,
			'ver'           => '1.0.0',
		);
		return $tabs;
