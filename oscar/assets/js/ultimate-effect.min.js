...
var bilalmghl_Buttons_Script = function ( $scope, $ ){ 
...
---------------------------------*/
 ...
 $(window).on('elementor/frontend/init', function () {
    elementorFrontend.hooks.addAction('frontend/element_ready/bilalmghl_Dual_Button.default', bilalmghl_Buttons_Script);
});
