...
class bilalmghl_Timeline_Slides_Widget extends Widget_Base {

    public function get_name() {
        return 'bilalmghl_Timeline_Slides_Widget';
    }
    
    public function get_title() {
        return __( 'OS timeline Slides', 'bilalmghl' );
    }
    ...
    static function content_layout_style(){
        return[
            'timeline__slides__layout__1'      => esc_html__( 'Style One', 'bilalmghl' ),
            'timeline__slides__layout__2'      => esc_html__( 'Style Two', 'bilalmghl' ),
            'timeline__slides__layout__custom' => esc_html__( 'Custom Style', 'bilalmghl' ),
        ];
    }
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'   => 'timeline__slides__layout__1',
                ...
                $repeater->start_controls_tab(
                    ...
                    $repeater->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} {{CURRENT_ITEM}} .timeline__slide__item__content' => 'justify-content: {{VALUE}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    $repeater->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} {{CURRENT_ITEM}} .timeline__slide__item__content' => 'text-align:{{VALUE}};',
                            ],
                            'default'   => '',
                            'separator' => 'before',
                        ]
                    ...
                    $repeater->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} {{CURRENT_ITEM}} .timeline__slide__item__inner__content' => 'text-align:{{VALUE}};',
                            ],
                            'default'   => '',
                            'separator' => 'before',
                        ]
                    ...
                    $repeater->add_group_control(
                        ...
                        [
                            ...
                            'selector'  => '{{WRAPPER}} {{CURRENT_ITEM}} .single__timeline__slide__bg__overlay',
                            'separator' => 'before',
                        ]
                    );
                    $repeater->add_control(
                    ...
                    $repeater->add_group_control(
                        ...
                        [
                            ...
                            'label'     => __( 'Background', 'bilalmghl' ),
                            'types'     => [ 'classic', 'gradient' ],
                            'selector'  => '{{WRAPPER}} {{CURRENT_ITEM}} .single__timeline__slide__bg__overlay:before,{{WRAPPER}} {{CURRENT_ITEM}} .single__timeline__slide__bg__overlay:after',
                            'separator' => 'before',
                        ]
                    );
                    $repeater->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} {{CURRENT_ITEM}} .single__timeline__slide__bg__overlay:before' => 'opacity: {{SIZE}};',
                                '{{WRAPPER}} {{CURRENT_ITEM}} .single__timeline__slide__bg__overlay:after'  => 'opacity: {{SIZE}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $repeater->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} {{CURRENT_ITEM}} .timeline__slide__item__content .timeline_slide_button_2 .bilalmghl__btn_icon' => 'color: {{VALUE}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    $repeater->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} {{CURRENT_ITEM}} .timeline__slide__item__content .timeline_slide_button_2' => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    $repeater->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'bilalmghl' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} {{CURRENT_ITEM}} .timeline__slide__item__content .timeline_slide_button_2',
                        ]
                    );
                    $repeater->add_group_control(
                    ...
                    $repeater->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} {{CURRENT_ITEM}} .timeline__slide__item__content .timeline_slide_button_2:hover .bilalmghl__btn_icon' => 'color: {{VALUE}} !important;',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    $repeater->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} {{CURRENT_ITEM}} .timeline__slide__item__content .timeline_slide_button_2:hover' => 'color: {{VALUE}} !important;',
                            ],
                        ]
                    );
                    $repeater->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'bilalmghl' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} {{CURRENT_ITEM}} .timeline__slide__item__content .timeline_slide_button_2:hover',
                        ]
                    );
                    $repeater->add_group_control(
                        Group_Control_Border::get_type(),
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'default'   => 1,
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__timeline__slide__item' => 'margin: calc( {{VALUE}}px / 2 );',
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bilalmghl__timeline__slide__item' => 'height: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__timeline__slide__item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .bilalmghl__timeline__slide__item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
        $this->end_controls_section();   
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .timeline__slide__item__content' => 'max-width: {{SIZE}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );
            $this->add_group_control(
                ...
                [
                    'name'      => 'box_border',
                    'label'     => esc_html__( 'Border', 'bilalmghl' ),
                    'selector'  => '{{WRAPPER}} .timeline__slide__item__content',
                    'separator' => 'before',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .timeline__slide__item__content' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
            $this->add_group_control(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .timeline__slide__item__content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .timeline__slide__item__content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .timeline__slide__item__content' => 'display: flex; align-items: {{VALUE}}',
                    ],
                    'separator' => 'before',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .timeline__slide__item__content' => 'justify-content: {{VALUE}};',
                    ],
                    'separator' => 'before',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .timeline__slide__item__content' => 'text-align: {{VALUE}};',
                    ],
                    'separator' => 'before',
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => esc_html__( 'Background', 'bilalmghl' ),
                    'types'    => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .timeline__slide__item__inner__content',
                ]
            );
            $this->add_responsive_control(
                'box_inner_max_width',
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .timeline__slide__item__inner__content' => 'max-width: {{SIZE}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .timeline__slide__item__inner__content' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
            $this->add_group_control(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .timeline__slide__item__inner__content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .timeline__slide__item__inner__content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .timeline__slide__item__inner__content' => 'text-align: {{VALUE}};',
                    ],
                    'separator' => 'before',
                ]
            );
				...
				$this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default'   => '',
                            'selectors' => [
                                '{{WRAPPER}} .timeline__slide__button' => 'color: {{VALUE}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'selector' => '{{WRAPPER}} .timeline__slide__button',
                        ]
                    );
					...
					$this->add_control(
						...
						[
							...
							'size_units' => [ 'px', '%', 'em' ],
							'selectors'  => [
								'{{WRAPPER}} .timeline__slide__button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
							],
						]
					);
					$this->add_group_control(
					...
					$this->add_responsive_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .timeline__slide__button' => 'width: {{SIZE}}{{UNIT}};',
							],
							'separator' => 'before',
						]
					);
					$this->add_responsive_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .timeline__slide__button' => 'height: {{SIZE}}{{UNIT}};',
							],
						]
					);
					$this->add_responsive_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .timeline__slide__button' => 'display: {{VALUE}};',
							],
							'separator' => 'before',
						]
					);
					$this->add_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .timeline__slide__button' => 'text-align: {{VALUE}};',
							],
							'separator' => 'before',
						]
					);
					$this->add_responsive_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .timeline__slide__button' => 'position: {{VALUE}};',
							],
							'separator' => 'before',
						]
					);
					$this->add_responsive_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .timeline__slide__button' => 'left: {{SIZE}}{{UNIT}};',
							],
							'condition' => [
								'button_position!' => ['']
							],
					...
					$this->add_responsive_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .timeline__slide__button' => 'right: {{SIZE}}{{UNIT}};',
							],
							'condition' => [
								'button_position!' => ['']
							],
					...
					$this->add_responsive_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .timeline__slide__button' => 'top: {{SIZE}}{{UNIT}};',
							],
							'condition' => [
								'button_position!' => ['']
							],
					...
					$this->add_responsive_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .timeline__slide__button' => 'bottom: {{SIZE}}{{UNIT}};',
							],
							'condition' => [
								'button_position!' => ['']
							],
					...
					$this->add_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .timeline__slide__button,{{WRAPPER}} .timeline__slide__button img' => 'transition: {{SIZE}}s;',
							],
							'separator' => 'before',
						]
					);
					$this->add_responsive_control(
						...
						[
							...
							'size_units' => [ 'px', '%', 'em' ],
							'selectors'  => [
								'{{WRAPPER}} .timeline__slide__button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
							],
							'separator' => 'before',
						]
					);
					$this->add_responsive_control(
						...
						[
							...
							'size_units' => [ 'px', '%', 'em' ],
							'selectors'  => [
								'{{WRAPPER}} .timeline__slide__button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
								'{{WRAPPER}} .timeline__slide__button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
							],
						]
					);
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'type'      => Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .timeline__slide__button:hover' => 'color: {{VALUE}};',
							],
							'separator' => 'before',
						]
					);
					$this->add_group_control(
						...
						[
							...
							'label'    => __( 'Background', 'bilalmghl' ),
							'types'    => [ 'classic', 'gradient' ],
							'selector' => '{{WRAPPER}} .timeline__slide__button:hover',
						]
					);
					$this->add_group_control(
						Group_Control_Border:: get_type(),
					...
					$this->add_control(
						...
						[
							...
							'size_units' => [ 'px', '%', 'em' ],
							'selectors'  => [
								'{{WRAPPER}} .timeline__slide__button:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
							],
						]
					);
					$this->add_group_control(
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'type'      => Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .bilalmghl__btn_icon' => 'color: {{VALUE}};',
							],
							'separator' => 'before',
						]
					);
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .bilalmghl__btn_icon i'   => 'font-size: {{SIZE}}{{UNIT}};',
                                '{{WRAPPER}} .bilalmghl__btn_icon img' => 'width: {{SIZE}}{{UNIT}};',
                                '{{WRAPPER}} .bilalmghl__btn_icon svg' => 'width: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
					$this->add_control(
						...
						[
							...
							'type'      => Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .timeline__slide__button:hover i' => 'color: {{VALUE}};',
							],
						]
					);
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .bilalmghl__btn_icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
							'separator' => 'before',
                        ]
                    );
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'bilalmghl_content_main_wrap', 'class', 'sldier-content-area' );
        $this->add_render_attribute( 'bilalmghl_content_main_wrap', 'class', $settings['nav_position'] );

        // Slier Main Content Area Class
        $this->add_render_attribute( 'bilalmghl_content_main_wrap', 'class', 'bilalmghl-timeline-slides-content-area' );

        if( $settings['slider_on'] == 'yes' ){

            $this->add_render_attribute( 'bilalmghl_content_wrap_attr', 'class', 'bilalmghl-carousel-activation' );
            ...
            $this->add_render_attribute( 'bilalmghl_content_wrap_attr', 'data-settings', wp_json_encode( $slider_settings ) );
        }else{
            $this->add_render_attribute( 'bilalmghl_content_wrap_attr', 'class', 'bilalmghl-timeline-area' );
        }

        // Slider Item Main Class
        $this->add_render_attribute( 'bilalmghl_carousel_item_parent_attr', 'class', 'bilalmghl__timeline__slide__item' );
        $this->add_render_attribute( 'bilalmghl_carousel_item_parent_attr', 'class', $settings['content_layout_style'] );

        // Item Content Class
        $this->add_render_attribute( 'bilalmghl_carousel_item_attr', 'class', 'timeline__slide__item__content' );

        /*  <?php echo esc_attr( 'elementor-repeater-item-'.$_single['_id'] ) ?> */

    ?>
        <div <?php echo $this->get_render_attribute_string('bilalmghl_content_main_wrap'); ?>>

            <div <?php echo $this->get_render_attribute_string('bilalmghl_content_wrap_attr'); ?>>
                <?php
 $i = 0;
 foreach ( $settings['content_slide_list'] as $_single ): 
    $i++;?>
                 <!-- foreach ( $settings['content_slide_list'] as $_single ): ?> -->

                    <?php
                        $slide_item_attribute = [
                            'bilalmghl__timeline__slide__item',
...
<?php if( $i%2 == 0 ): ?>
                    ...
                    <?php else : ?>
                        ...
                        <div class="single__timeline__slide__bg__overlay"></div>
                        <div <?php echo $this->get_render_attribute_string('bilalmghl_carousel_item_attr'); ?>>

                            <?php if( 'yes' == $settings['show_content'] ) : ?>
                                <div class="timeline__slide__item__inner__content">
                                    ...
                                    <?php if( $settings['show_title'] == 'yes' && !empty($_single['content_title']) ): ?>
                                        <h3 class="slide__title sdsddsd"><?php echo bilalmghl_kses($_single['content_title']); ?></h3>
                                    <?php endif; ?>
                                            ...
                                            <?php if( 'yes' == $_single['show_button_1'] ) : ?>
                                                <?php
                                                    ...
                                                    if( 'default' == $_single['button_1_type'] ){
                                                        ...
                                                        $button_1_attribute[] = 'class="timeline__slide__button"';
                                                        ...
                                                        if ( !empty( $_single['button_1_icon'] ) ) {
                                                            ...
                                                            if ( 'left' == $_single['button_1_icon_align'] ) {
                                                                ...
                                                                $button = '<a ' . implode( ' ', $button_1_attribute ) . '>
                                                                        <div class="bilalmghl__btn_icon">' . bilalmghl_render_icons( $_single['button_1_icon'] ) . '</div>
                                                        ...
                                                        if ( !empty( $_single['button_1_icon'] ) ) {
                                                            ...
                                                            if (  'left' == $_single['button_1_icon_align'] ) {
                                                                ...
                                                                $button = '<div '.implode( ' ', $button_1_attribute ).'>
                                                                    <div class="button__icon video__button_icon_left">'.bilalmghl_render_icons( $_single['button_1_icon'] ).'</div>
                                                                ...
                                                                $button = '<div '.implode( ' ', $button_1_attribute ).'>
                                                                    <div class="button__text">'. $_single['button_1_title'] .'</div>
                                                                    <div class="button__icon video__button_icon_right">'.bilalmghl_render_icons( $_single['button_1_icon'] ).'</div>
                                                                </div>';
                                                            }
                                                        }
                                                        $button_1_attribute = array();
                                            ...
                                            <?php if( 'yes' == $_single['show_button_2'] ) : ?>
                                                <?php
                                                    ...
                                                    if( 'default' == $_single['button_2_type'] ){
                                                        ...
                                                        $button_2_attribute[] = 'class="timeline__slide__button timeline_slide_button_2"';
                                                        ...
                                                        if ( !empty( $_single['button_2_icon'] ) ) {
                                                            ...
                                                            if ( 'left' == $_single['button_2_icon_align'] ) {
                                                                ...
                                                                $button_2 = '<a ' . implode( ' ', $button_2_attribute ) . '>
                                                                        <div class="bilalmghl__btn_icon">' . bilalmghl_render_icons( $_single['button_2_icon'] ) . '</div>
                                                        ...
                                                        if ( !empty( $_single['button_2_icon'] ) ) {
                                                            ...
                                                            if (  'left' == $_single['button_2_icon_align'] ) {
                                                                ...
                                                                $button_2 = '<div '.implode( ' ', $button_2_attribute ).'>
                                                                    <div class="button__icon video__button_icon_left">'.bilalmghl_render_icons( $_single['button_2_icon'] ).'</div>
                                                                ...
                                                                $button_2 = '<div '.implode( ' ', $button_2_attribute ).'>
                                                                    <div class="button__text">'. $_single['button_2_title'] .'</div>
                                                                    <div class="button__icon video__button_icon_right">'.bilalmghl_render_icons( $_single['button_2_icon'] ).'</div>
                                                                </div>';
                                                            }
                                                        }
                                                        $button_2_attribute = array();
...
<?php else : ?>
                    ...
                    <?php else : ?>
                        ...
                        <div class="single__timeline__slide__bg__overlay jhjsdjhdjh"></div>
                        <div <?php echo $this->get_render_attribute_string('bilalmghl_carousel_item_attr'); ?>>
                            ...
                            <?php if( 'yes' == $settings['show_content'] ) : ?>
                                <div class="timeline__slide__item__inner__content">
                                    ...
                                    <?php if( $settings['show_title'] == 'yes' && !empty($_single['content_title']) ): ?>
                                        <h3 class="slide__title"><?php echo bilalmghl_kses($_single['content_title']); ?></h3>
                                    <?php endif; ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new bilalmghl_Timeline_Slides_Widget() );