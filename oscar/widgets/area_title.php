...
class Oscar_Area_Title extends Widget_Base {

	public function get_name() {
		return 'OscarAreaTitle';
	}

	public function get_title() {
		return __( 'Section Title', 'bilalmghl' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'{{WRAPPER}} .section-heading .title__bg__icon' => 'color: {{VALUE}};',
					],
				]
			);
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .section-heading .title__bg__icon',
				]
			);
			$this->add_responsive_control(
				'bgicon_image_size',
				[
					...
					'selectors' => [
						'{{WRAPPER}} .section-heading .title__bg__icon img' => 'width: {{SIZE}}{{UNIT}};',
						'{{WRAPPER}} .section-heading .title__bg__icon svg' => 'width: {{SIZE}}{{UNIT}};',
					],
				]
			);
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .section-heading .title__bg__icon' => 'width: {{SIZE}}{{UNIT}};',
					],
					'separator' => 'before',
				]
			);
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors'  => [
						'{{WRAPPER}} .section-heading .title__bg__icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'separator' => 'before',
				]
			);
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors'  => [
						'{{WRAPPER}} .section-heading .title__bg__icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .section-heading .title__bg__icon' => 'opacity: {{SIZE}};',
					],
					'separator' => 'before',
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'{{WRAPPER}} .section-heading .title__bg__text' => 'color: {{VALUE}};',
					],
				]
			);
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .section-heading .title__bg__text',
				]
			);
			$this->add_responsive_control(
				'bgtext_margin',
				[
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors'  => [
						'{{WRAPPER}} .section-heading .title__bg__text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'separator' => 'before',
				]
			);
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', '%', 'em' ],
					'selectors'  => [
						'{{WRAPPER}} .section-heading .title__bg__text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .section-heading .title__bg__text' => 'opacity: {{SIZE}};',
					],
					'separator' => 'before',
				]
			);
			$this->add_control(
				...
				[
					...
					'step'      => 1,
					'selectors' => [
						'{{WRAPPER}} .section-heading .title__bg__text' => 'z-index: {{SIZE}};',
					],
					'separator' => 'before',
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} :hover .small-title' => 'color: {{VALUE}}',
					],
				]
			);
			$this->add_group_control(
	        ...
	        $this->add_responsive_control(
	            ...
	            [
	                ...
	                'size_units' => [ 'px', '%', 'em' ],
	                'selectors'  => [
	                    '{{WRAPPER}} .small-title' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	                ],
	            ]
	        );
			$this->add_responsive_control(
				...
				$this->start_controls_tab(
					...
					$this->add_responsive_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .oscar-btn i' => 'font-size: {{SIZE}}{{UNIT}};',
								'{{WRAPPER}} .oscar-btn svg' => 'width: {{SIZE}}{{UNIT}};',
							],
						]
					);
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} :hover .section-heading' => 'color: {{VALUE}}',
					],
				]
			);
			$this->add_responsive_control(
	...
	protected function render() {
		...
		if ( !empty( $settings['title'] ) ) {
			$title = '<'.$title_tag.' class="title">'.wpautop( $settings['title'] ).'</'.$title_tag.'>';
		}else{
			$title = '';
		}
		...
		if ( !empty( $settings['subtitle'] ) ) {
			$subtitle = '<div class="small-title">'.esc_html( $settings['subtitle'] ).'</div>';
		}else{
			$subtitle = '';
		}
		...
		if ( !empty( $settings['description'] ) ) {
			$description = '<div class="section-description">'.wpautop( $settings['description'] ).'</div>';
		}else{
			$description = '';
		}
		...
		if ( 'yes' == $settings['show_button'] && ( !empty($settings['button_text'] ) && !empty($settings['button_link'] ) ) ) {
			$button = '<a class="oscar-btn '. esc_attr( $button_animation ) .'" '.$this->get_render_attribute_string( 'more_button' ).'>'. esc_html( $settings['button_text'] ) .'</a>';
		}

		/*Button With Icon*/
		if ( !empty( $settings['button_icon'] ) ) {
			if ( 'left' == $settings['button_icon_align'] ) {
				$button = '<a class="oscar-btn ' . esc_attr( $button_animation ) . '" ' . $this->get_render_attribute_string( 'more_button' ) . '>' . bilalmghl_render_icons( $settings['button_icon'], 'oscar-btn_icon_left' ) . esc_html( $settings['button_text'] ) . '</a>';
			} elseif ( 'right' == $settings['button_icon_align'] ) {
				$button = '<a class="oscar-btn ' . esc_attr( $button_animation ) . '" ' . $this->get_render_attribute_string( 'more_button' ) . '>' . esc_html( $settings['button_text'] ) . bilalmghl_render_icons( $settings['button_icon'], 'oscar-btn_icon_right' ) . '</a>';
			}
		}
...
Plugin::instance()->widgets_manager->register_widget_type( new Oscar_Area_Title() );