...
class Oscar_Post_Carousel extends Widget_Base {

    public function get_name() {
        return 'Oscar_Post_Carousel';
    }
    
    public function get_title() {
        return __( 'Ul Post carousel', 'bilalmghl' );
    }
    ...
    static function content_layout_style(){
        return[
            '1' => __( 'Layout 1', 'bilalmghl' ),
            '2' => __( 'Layout 2', 'bilalmghl' ),
            '3' => __( 'Layout 3', 'bilalmghl' ),
            '4' => __( 'Layout 4', 'bilalmghl' ),
            '5' => __( 'Layout 2', 'bilalmghl' ),
            '9' => __( 'Layout 9', 'bilalmghl' ),
        ];
    }

    static function oscar_get_post_types( $args = [] ) {
    ...
    static function oscar_get_taxonomies( $oscar_texonomy = 'category' ){
        $terms = get_terms( array(
            'taxonomy'   => $oscar_texonomy,
            'hide_empty' => true,
        ));
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post carousel', 'bilalmghl' ),
            ]
        );
            ...
            $this->add_control(
                'slider_on',
                [
                    'label'        => __( 'Carousel', 'bilalmghl' ),
                    'type'         => Controls_Manager::SWITCHER,
                    'label_on'     => __( 'On', 'bilalmghl' ),
                    'label_off'    => __( 'Off', 'bilalmghl' ),
                    'return_value' => 'yes',
                    'default'      => 'yes',
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'options'     => self::oscar_get_post_types(),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'multiple'    => true,
                    'options'     => self::oscar_get_taxonomies(),
                    'condition'   => [
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'multiple'    => true,
                    'options'     => self::oscar_get_taxonomies('product_cat'),
                    'condition'   => [
            ...
            $this->add_control(
                'date_format',
                [
                    'label'   => esc_html__( 'Date Format', 'bilalmghl' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => 'M d, Y',
                    'options' => [
                        'M d, Y'       => esc_html__('Nov 06, 2014','bilalmghl'),
                        'F d, Y'       => esc_html__('November 06, 2014','bilalmghl'),
                        'd M Y'        => esc_html__('01 Nov 2014','bilalmghl'),
                        'd F Y'        => esc_html__('01 November 2014','bilalmghl'),
                        'M d'          => esc_html__('Nov 01','bilalmghl'),
                        'd M'          => esc_html__('01 Nov','bilalmghl'),
                        'F d'          => esc_html__('November 01','bilalmghl'),
                        
                        'F jS, Y'      => esc_html__('November 6th, 2014','bilalmghl'),
                        'M jS, Y'      => esc_html__('Nov 6th, 2014','bilalmghl'),
                        
                        'jS F, Y'      => esc_html__('6th November, 2014','bilalmghl'),
                        'jS M, Y'      => esc_html__('6th Nov, 2014','bilalmghl'),
                        
                        'l, F jS, Y'   => esc_html__('Thursday, November 6th, 2014','bilalmghl'),
                        'D, F jS, Y'   => esc_html__('Thu, November 6th, 2014','bilalmghl'),

                        'F j, Y g:i a' => esc_html__('November 6, 2010 12:50 am','bilalmghl'),
                        'M j, Y g:i a' => esc_html__('Nov 6, 2010 12:50 am','bilalmghl'),
                    ],
                    'condition' => [
                        'show_date' => 'yes',
                    ]
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .oscar-btn .readmore_icon_right' => 'margin-left: {{SIZE}}{{UNIT}};',
                        '{{WRAPPER}} .oscar-btn .readmore_icon_left'  => 'margin-right: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'default'   => 1,
                    'selectors'  => [
                        '{{WRAPPER}} .blog-thumb' => 'margin: calc( {{VALUE}}px / 2 );',
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'   => 'no',
                    'selectors'  => [
                        '{{WRAPPER}} .sldier-content-area .slick-nav > div' => '{{VALUE}}',
                    ],
                    'condition'   => [
                        'slarrows' => 'yes',
                    ]
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .blog-thumb' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .blog-thumb' => 'overflow:hidden;border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .blog-thumb' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .blog-thumb' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors'          => [
                        '{{WRAPPER}} .blog-thumb' => 'margin-top: {{TOP}}{{UNIT}}; margin-bottom:{{BOTTOM}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .blog-thumb:nth-child(2n)' => 'margin-top: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .blog-thumb:hover' => 'transform: translateY({{SIZE}}{{UNIT}});',
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'   => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .blog-thumb .text' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Typography', 'bilalmghl' ),
                    'selector' => '{{WRAPPER}} .blog-thumb .text',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .blog-thumb .text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .blog-thumb .text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .blog-thumb .text' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'bilalmghl' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .blog-thumb .blog-figure',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Border:: get_type(),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .blog-thumb .blog-figure,{{WRAPPER}} .blog-thumb .blog-figure' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .blog-thumb .blog-figure' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .blog-thumb .blog-figure' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'bilalmghl' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .blog-thumb:hover .blog-figure',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Border:: get_type(),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .blog-thumb:hover .blog-figure,
                                {{WRAPPER}} .blog-thumb:hover .blog-figure' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'   => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .blog-thumb .title a' => 'color: {{VALUE}}',
                        '{{WRAPPER}} .blog-thumb .title' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'   => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .blog-thumb .title:hover a' => 'color: {{VALUE}}',
                        '{{WRAPPER}} .blog-thumb .title:hover' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Typography', 'bilalmghl' ),
                    'selector' => '{{WRAPPER}} .blog-thumb .title',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .blog-thumb .title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .blog-thumb .title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .blog-thumb .title' => 'text-align: {{VALUE}};',
                    ],
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Typography', 'bilalmghl' ),
                            'selector' => '{{WRAPPER}} .blog-thumb .blog-meta-category a',
                        ]
                    );
                    $this->add_control(
                        'category_color',
                        [
                            ...
                            'type'   => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .blog-thumb .blog-meta-category a' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .blog-thumb .blog-meta-category a' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .blog-thumb .blog-meta-category' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .blog-thumb .blog-meta-category a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'   => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .blog-thumb .blog-meta-category a:hover' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'bilalmghl' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .blog-thumb .blog-meta-category a:hover',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .blog-thumb .blog-meta-category a:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'   => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .blog-thumb ul.blog-meta'=> 'color: {{VALUE}}',
                        '{{WRAPPER}} .blog-thumb ul.blog-meta a' => 'color: {{VALUE}}',
                    ],
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Typography', 'bilalmghl' ),
                    'selector' => '
                        {{WRAPPER}} .blog-thumb ul.blog-meta li
                    ',
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => __( 'Background', 'bilalmghl' ),
                    'types'    => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .blog-thumb ul.blog-meta',
                ]
            );
            $this->add_group_control(
                Group_Control_Border:: get_type(),
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .blog-thumb ul.blog-meta' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .blog-thumb ul.blog-meta li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors'  => [
                        '{{WRAPPER}} .blog-thumb ul.blog-meta li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .blog-thumb ul.blog-meta' => 'justify-content: {{VALUE}};',
                    ],
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'   => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .blog-thumb .post__btn a.oscar-btn' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Typography', 'bilalmghl' ),
                            'selector' => '{{WRAPPER}} .blog-thumb .post__btn a.oscar-btn',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Background:: get_type(),
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'bilalmghl' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .blog-thumb .post__btn a.oscar-btn:after',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Border:: get_type(),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .blog-thumb .post__btn a.oscar-btn' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .blog-thumb .post__btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors'  => [
                                '{{WRAPPER}} .blog-thumb .post__btn a.oscar-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                        ]
                    );
                $this->end_controls_tab();
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'   => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .blog-thumb .post__btn a.oscar-btn:hover' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => __( 'Background', 'bilalmghl' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .blog-thumb .post__btn a.oscar-btn:hover',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Background:: get_type(),
                        [
                            ...
                            'label'    => __( 'After Background', 'bilalmghl' ),
                            'types'    => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .blog-thumb .post__btn a.oscar-btn:hover:after',
                        ]
                    );
                    $this->add_group_control(
                        Group_Control_Border:: get_type(),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .blog-thumb .post__btn a.oscar-btn:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    $this->add_group_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => __( 'Background', 'bilalmghl' ),
                'types'    => [ 'classic', 'gradient' ],
                'selector' => '{{WRAPPER}} .sldier-content-area .slick-nav',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors'  => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'display: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'position: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'left: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'right: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'slider_nav_warp_position' => ['absolute','relative']
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'top: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'slider_nav_warp_position' => ['absolute','relative']
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'bottom: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'slider_nav_warp_position' => ['absolute','relative']
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'text-align: {{VALUE}};',
                ],
                'default' => '',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'step'      => 1,
                'selectors' => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'z-index: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors'  => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors'  => [
                    '{{WRAPPER}} .sldier-content-area .slick-nav' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .sldier-content-area .slick-nav > div.slick-prev' => 'left: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .sldier-content-area .slick-nav > div.slick-prev' => 'top: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .sldier-content-area .slick-nav > div.slick-next' => 'right: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .sldier-content-area .slick-nav > div.slick-next' => 'top: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .sldier-content-area:hover .slick-nav > div.slick-prev' => 'left: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .sldier-content-area:hover .slick-nav > div.slick-prev' => 'top: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .sldier-content-area:hover .slick-nav > div.slick-next' => 'right: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .sldier-content-area:hover .slick-nav > div.slick-next' => 'top: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'oscar_post_carousel', 'class', 'blog-slider-wraper blog-slider-style-'.$settings['content_layout_style']. ' '.$settings['nav_position'] );

        $this->add_render_attribute( 'oscar_post_slider_item_attr', 'class', 'blog-thumb blog-thumb-'.$settings['content_layout_style'] );


        // Slider options
        if( $settings['slider_on'] == 'yes' ){

            $this->add_render_attribute( 'oscar_post_slider_attr', 'class', 'oscar-carousel-activation' );
            ...
            $this->add_render_attribute( 'oscar_post_slider_attr', 'data-settings', wp_json_encode( $slider_settings ) );
        }
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'oscar_post_carousel' ); ?>>
                <div <?php echo $this->get_render_attribute_string( 'oscar_post_slider_attr' ); ?>>
                    ...
                    ?>
                        ...
                        <?php if( $settings['content_layout_style'] == 1 ): ?>
                            ...
                            <div <?php echo $this->get_render_attribute_string( 'oscar_post_slider_item_attr' ); ?> >
                                <?php $this->oscar_render_loop_content( 1 ); ?>
                            </div>
                        ...
                        <?php elseif( $settings['content_layout_style'] == 2 ): ?>
                            ...
                            <div <?php echo $this->get_render_attribute_string( 'oscar_post_slider_item_attr' ); ?> >
                                <div class="post__carousel__flex">
                                    <?php $this->oscar_render_loop_content( 2 ); ?>
                                </div>
                            </div>
                        ...
                        <?php elseif( $settings['content_layout_style'] == 4 ): ?>
                            ...
                            <div <?php echo $this->get_render_attribute_string( 'oscar_post_slider_item_attr' ); ?> >
                                <?php $this->oscar_render_loop_content( 4 ); ?>
                            </div>

                        <?php elseif( $settings['content_layout_style'] == 5 ): ?>

                            <div <?php echo $this->get_render_attribute_string( 'oscar_post_slider_item_attr' ); ?> >
                                <?php $this->oscar_render_loop_content( 5 ); ?>
                            </div>

                        <?php elseif( $settings['content_layout_style'] == 6 ): ?>

                            <div <?php echo $this->get_render_attribute_string( 'oscar_post_slider_item_attr' ); ?> >
                                <?php $this->oscar_render_loop_content( 6 ); ?>
                            </div>

                        <?php elseif( $settings['content_layout_style'] == 7 ): ?>

                            <div <?php echo $this->get_render_attribute_string( 'oscar_post_slider_item_attr' ); ?> >
                                <?php $this->oscar_render_loop_content( 7 ); ?>
                            </div>

                        <?php elseif( $settings['content_layout_style'] == 8 ): ?>

                            <div <?php echo $this->get_render_attribute_string( 'oscar_post_slider_item_attr' ); ?> >
                                <?php $this->oscar_render_loop_content( 8 ); ?>
                            </div>

                        <?php elseif( $settings['content_layout_style'] == 9 ): ?>

                            <div <?php echo $this->get_render_attribute_string( 'oscar_post_slider_item_attr' ); ?> >
                                <?php $this->oscar_render_loop_content( 9 ); ?>
                            </div>
    ...
    // Loop Content
    public function oscar_render_loop_content( $contetntstyle = NULL ){
        $settings   = $this->get_settings_for_display(); ?>
            ...
            <?php if( $contetntstyle == 1 ) : ?>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text">
                            <?php $this->oscar_post_meta(); ?>
                            <?php $this->oscar_post_title(); ?>
                            <?php $this->oscar_post_content(); ?>
                            
                            <?php $this->oscar_post_readmore(); ?>
                        </div>
                    </div>
                    <?php
                    global $post;
                    ...
                    <?php if ( 'yes' == $settings['show_thumb'] && has_post_thumbnail() ) : ?>
                        <div class="col-lg-6">
                            <div class="blog-figure">
                                <img src="<?php echo esc_url( $thumb_link ) ?>" alt="<?php the_title(); ?>">
                            </div>
                        </div>
                    <?php endif;?>
                </div>
            <?php elseif( $contetntstyle == 2 ) : ?>
                <?php $this->oscar_post_thumbnail(); ?>
                <div class="text">
                    <?php $this->oscar_post_meta(); ?>
                    <?php $this->oscar_post_title(); ?>
                    <?php $this->oscar_post_content(); ?>
            ...
            <?php elseif( $contetntstyle == 7 ) : ?>
                ...
                <div class="post__content">
                    <div class="post__inner">
                        <?php $this->oscar_post_title(); ?>
                        <?php $this->oscar_post_content(); ?>
                        <?php $this->oscar_post_author_comments_date_meta(); ?>
                    </div>
                </div>
            ...
            <?php elseif( $contetntstyle == 9 ) : ?>
                    ...
                    <div class="blog-figure">
                            ...
                            <div class="blog-meta-time">
                                <?php if( $settings['show_date'] == 'yes' ):?>

                                    <?php if( 'date'== $settings['date_type'] ) : ?>                                
                                    <div><?php the_time($settings['date_format']);?></div>
                                    <?php endif; ?>
                                    ...
                                    <div><?php echo $this->oscar_time_ago(); ?></div>
                                    <?php endif; ?>
                                    
                                    <?php if( 'date_time'== $settings['date_type'] ) : ?>
                                    <div><?php echo get_the_time( 'd F y - D g:i:a' ) ?></div>
                                    <?php endif; ?>
    ...
    public function oscar_post_category(){
        $settings   = $this->get_settings_for_display(); ?>
    ...
    public function oscar_post_title(){
        $settings   = $this->get_settings_for_display(); ?>
    ...
    public function oscar_post_content(){
        $settings   = $this->get_settings_for_display();
    ...
    public function oscar_post_meta(){
        $settings   = $this->get_settings_for_display(); ?>
        <?php if( $settings['show_author'] == 'yes' || $settings['show_date'] == 'yes'): ?>
            <ul class="blog-meta">
                ...
                <?php if( $settings['show_date'] == 'yes' ):?>
                    ...
                    <?php if( 'time_ago' == $settings['date_type'] ) : ?>
                    <li><i class="fa fa-clock-o"></i><?php echo $this->oscar_time_ago(); ?></li>
                    <?php endif; ?>
    ...
    public function oscar_post_author(){
        $settings   = $this->get_settings_for_display(); ?>
        <?php if( $settings['show_author'] == 'yes' ): ?>
        <div class="post__author__meta blog-meta">
            <div class="post__author__thumb__link">
                <a class="post__author__thumb" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>">
                    <img src="<?php echo esc_url( get_avatar_url( get_the_author_meta( 'email' ) ) ); ?>" alt="<?php the_author(); ?>">
                </a>
                <a class="author__link" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>">
    ...
    public function oscar_post_readmore(){
        $settings   = $this->get_settings_for_display(); ?>
        <?php if( $settings['show_read_more_btn'] == 'yes' ): ?>
            <a class="oscar-btn <?php echo esc_html__( $settings['readmore_icon_position'], 'bilalmghl' );?>" href="<?php the_permalink();?>">
                <span><?php echo esc_html__( $settings['read_more_txt'], 'bilalmghl' );?></span>
                <?php if ( !empty( $settings['readmore_icon'] ) ) : ?>
                <?php echo oscar_render_icons( $settings['readmore_icon'] ) ?>
                <?php endif; ?>
            </a>
        <?php endif;
    }

    public function oscar_post_author_comments_date_meta(){
        $settings   = $this->get_settings_for_display(); ?>
    ...
    public function oscar_only_date(){
        $settings   = $this->get_settings_for_display(); ?>
        <?php if( $settings['show_author'] == 'yes' || $settings['show_date'] == 'yes'): ?>
            <li class="blog-meta-time">
                <?php if( $settings['show_date'] == 'yes' ):?>
    ...
    public function oscar_comment_count(){
        $settings   = $this->get_settings_for_display();
        ...
        if (! post_password_required() && ( comments_open() || get_comments_number() ) ) { 
            ...
            echo '<div class="comments__count">'.$comment_count.'</div>';
        }
    }

}
Plugin::instance()->widgets_manager->register_widget_type( new Oscar_Post_Carousel() );