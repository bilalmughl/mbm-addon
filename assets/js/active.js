;(function ($) {
    ...
    var bilalmghl_Adv_Accordion_Script_Handle = function($scope, $) {
        var $advanceAccordion     = $scope.find(".bilalmghl__adv__accordion"),
            $accordionHeader      = $scope.find(".bilalmghl__accordion__header"),
        ...
        $accordionHeader.click(function(e) {
            ...
            if ($accordionType === "accordion") {
                if ($this.hasClass("show")) {
                    ...
                    $this.parent().parent().find(".bilalmghl__accordion__header").removeClass("show active");
                    $this.parent().parent().find(".bilalmghl__accordion__content").slideUp($accordionSpeed);
        ...
        TABS ACTIVE
    ----------------------------------*/
    var bilalmghl_Tabs_Script = function($scope ,$){
	...
	var Owl_Carousel_Script_Handle = function ($scope, $){
		...
		var carousel_elem     = $scope.find('.bilalmghl-carousel-active').eq(0);
    ...
    var Slick_Carousel_Script_Handle = function ($scope, $) {
        ...
        var carousel_elem = $scope.find( '.bilalmghl-carousel-activation' ).eq(0);
        ...
        if ( carousel_elem.length > 0 ) {
            ...
            if( carousel_style_ck == 4 ){
                carousel_elem.slick({
                    appendArrows: '.bilalmghl-carousel-nav'+slideid,
                    appendDots  : '.bilalmghl-carousel-dots'+slideid,
                    arrows      : arrows,
                    prevArrow   : '<div class="bilalmghl-carosul-prev owl-prev"><i class="'+arrow_prev_txt+'"></i></div>',
                    nextArrow   : '<div class="bilalmghl-carosul-next owl-next"><i class="'+arrow_next_txt+'"></i></div>',
                    dots        : dots,
                    customPaging: function( slick,index ) {
                        var data_title = slick.$slides.eq(index).find('.bilalmghl-data-title').data('title');
    ...
    ------------------------------*/
    var bilalmghl_Slider_Animation_Script = function($scope, $){

        var $sliderArea = $('.bilalmghl-carousel-activation');
    ...
    var Swiper_Carousel_Script_Handle = function ($scope, $) {
        ...
        var mobile_item_scroll = parseInt(settings['mobile_item_scroll']) || 1;
            ...
            if ( arrows === true ) {                
               var  navigation = {
                    nextEl: '.bilalmghl-carosul-next'+slideid,
                    prevEl: '.bilalmghl-carosul-prev'+slideid,
                };
            }else{
                var navigation = '';
            }
            ...
            if ( dots === true ) {
                var dots_type 
                var pagination = {
                    el                : '.bilalmghl-carousel-dots'+slideid,
    ...
    /*--------------------------------
        CIRCLE PROGRESSBAR
    ---------------------------------*/
    var bilalmghl_Counter_Circle_Widget_Script_Handle = function($scope, $) {
        
        var circle_progressbar  = $scope.find('.bilalmghl__progress__counter').eq(0);
        ...
        var active_progressbar = $("#bilalmghl__progress__counter__"+random_id+"");
    ...
    ----------------------------------*/
    var bilalmghl_Countdown_Circle_Timer_Script = function ($scope, $) {
        var countdown_time_circle = $scope.find('.bilalmghl__circle__countdown').eq(0);
        ...
        var countdown             = $("#bilalmghl__circle__countdown__"+random_id+"");
    ...
    ---------------------------------*/
    var bilalmghl_Give_Campains_Widget_Script = function () {
    ...
    var Timeline_Script_Handle_Data = function ( $scope, $ ){
        ...
        var timeline_content         = $scope.find('.bilalmghl__timeline__activation').eq(0);
        ...
        $('#bilalmghl__timeline__'+timeline_id+' .timeline').timeline({
    ...
    var Timeline_Roadmap_Script_Handle_Data = function ( $scope, $ ){
        var roadmap_content = $scope.find('.bilalmghl__roadmap__activation').eq(0);
        ...
        $( '#bilalmghl__roadmap__timeline__'+random_id ).roadmap(content, {
    ...
    -------------------------------------*/
    var bilalmghl_Progressbar_Script = function () {
        $('.bilalmghl__progressbar').each(function () {
            $(this).appear(function () {
                $(this).find('.count__bar').animate({
                    width: $(this).attr('data-percent')
                }, 1000);
    ...
    -------------------------------------*/
    var bilalmghl_Masonry_Filter_Script = function($scope, $ ){
        var grid_elem            = $scope.find('.bilalmghl-filter-activation').eq(0);
        ...
        if ( 'slider' != settings['gallery_type'] || 'genaral' != settings['gallery_type'] ) {
            ...
            var item_selector        = '.bilalmghl__grid__item__'+gallery_id;
    ...
    /*var WidgetImageMasonaryHandler = function ($scope, $) {
        var masonry_elem = $scope.find('.bilalmghl-masonry-activation').eq(0);
    ...
    -----------------------------------------*/
    var bilalmghl_Product_Tabs_Filter = function(){
    ...
    -----------------------------------------*/
    var bilalmghl_Edd_Search_Widget_Script = function($scope, $){
    ...
    /*---------------------------------------
        EDD CATEGORY SEARCH FEATURES SELECT
    -----------------------------------------*/
    var bilalmghl_Tooltip_Modal_Script = function($scope, $){

        var tooltip_content = $('.bilalmghl__toltip__modal');
    ...
    -----------------------------------------*/
    var bilalmghl_Add_Span_To_First_Word = function($scope, $){
    ...
    var Animate_Headline_Script = function($scope,$){
        ...
        var headline_content = $scope.find('.bilalmghl__animate__heading__activation').eq(0);
    ...
    var bilalmghl_Flip_Box_Script = function( $scope, $){
    ...
    var bilalmghl_Progress_Script = function($scope, $){
        var element             = $scope.find( '.bilalmghl__progressbar__activation' ).eq(0);
    ...
    var bilalmghl_Image_Compare_Script = function($scope, $){
    ...
    var Global_Element_Ready_Script = function( $scope ){
        ...
        var bilalmghlFloatingEffect = elementorModules.frontend.handlers.Base.extend({
            onInit: function () {
            ...
            getConfig: function (key) {
                return this.getElementSettings('bilalmghl_floating_fx_' + key);
            },
            ...
            run: function () {
                ...
                if (settings.bilalmghl_tilt_effect) {
        ...
        new bilalmghlFloatingEffect({
            $element: $scope
        });
    }

	$(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Adv_Accordion.default', bilalmghl_Adv_Accordion_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Animate_Headline.default', Animate_Headline_Script );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghlTestmonial.default', Owl_Carousel_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghlTeams.default', Owl_Carousel_Script_Handle );


        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Multi_Gallery_Widget.default', Slick_Carousel_Script_Handle );        
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Multi_Gallery_Widget.default', bilalmghl_Masonry_Filter_Script );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Instagram_Widget.default', Slick_Carousel_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Post_Carousel.default', Slick_Carousel_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Post_Carousel.default', bilalmghl_Add_Span_To_First_Word );
        /*elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Post_Group.default', bilalmghl_Post_Group_Script );*/

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_WooCommerce_Products_Widget.default', bilalmghl_Product_Tabs_Filter );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Portfolio_Carousel.default', Slick_Carousel_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Portfolio.default', Slick_Carousel_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Portfolio.default', bilalmghl_Masonry_Filter_Script );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Image_Carousel.default', Slick_Carousel_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Subscriber_Widget.default', MailChimp_Subscribe_Form_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Image_Carousel_Alt.default', Swiper_Carousel_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Video_Button.default', Video_Popup_Button_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Counter_Circle_Widget.default', bilalmghl_Counter_Circle_Widget_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Countdown_Circle_Widget.default', bilalmghl_Countdown_Circle_Timer_Script );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Give_Campains_Widget.default', bilalmghl_Give_Campains_Widget_Script );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Give_Campains_Widget.default', Slick_Carousel_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Timeline_Widget.default', Timeline_Script_Handle_Data);

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Timeline_Roadmap_Widget.default', Timeline_Roadmap_Script_Handle_Data);

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Step_Timeline_Widget.default', Slick_Carousel_Script_Handle );
        
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Progress_Roadmap_Widget.default', bilalmghl_Progressbar_Script );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Progressbar_Widget.default', bilalmghl_Progress_Script );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Welcome_Slides_Widget.default', Slick_Carousel_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Welcome_Slides_Widget.default', Slider_Video_Popup_Button_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Welcome_Slides_Widget.default', bilalmghl_Slider_Animation_Script );
//**oscarrrrr**
elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Timeline_Slides_Widget.default', Slick_Carousel_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Timeline_Slides_Widget.default', Slider_Video_Popup_Button_Script_Handle );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Timeline_Slides_Widget.default', bilalmghl_Slider_Animation_Script );


        /* EDD FEATURES ENABLE*/
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Edd_Search_Widget.default', bilalmghl_Edd_Search_Widget_Script );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Edd_Products_Widget.default', Slick_Carousel_Script_Handle );        
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Edd_Products_Widget.default', bilalmghl_Masonry_Filter_Script );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Edd_Products_Widget.default', bilalmghl_Tooltip_Modal_Script );        
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Thumb_Category_Widget.default', Slick_Carousel_Script_Handle );

        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Scroll_Button.default', Scroll_Buttom_Script );
        
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Tabs_Menu_Widget.default', bilalmghl_Tabs_Script );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/bilalmghl_Price_Tabs_Widget.default', bilalmghl_Tabs_Script );
